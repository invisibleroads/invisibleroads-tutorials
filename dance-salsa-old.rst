...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- :ref:`Crossbody` while he raises his connected right hand and lowers his connected left so that she turns counterclockwise into reverse cuatro hold.
- :ref:`Cuatro break`
...
.. _Woman right turn from closed hold:
...
.. _Woman right turn, Right turn change hands, Woman right turn:

Woman right turn, man change hands, woman right turn
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- :ref:`Woman right turn from closed hold`
- :ref:`Right turn change hands, Woman right turn`
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
As soon as the man signals a :ref:`Woman right turn from closed hold`, he spins clockwise and left steps forward.
...
.. _Woman right turn from open hold:
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
From open hold, man turns clockwise under his connected right arm, then signals a :ref:`Whip crossbody`.
...
.. _Right turn change hands, woman right turn:
...
.. _Man half right, woman blind turn:
...
Sombrero crossbody
^^^^^^^^^^^^^^^^^^
From left cross hold, man moves into crossbody stance, wraps her left arm behind his neck and his right arm behind her left shoulder and completes the :ref:`Crossbody`.
...
.. _Woman right turn from right over left hold:
...
.. _Woman right turn from right over left hold, sombrero close:

Woman right turn from right over left hold, sombrero close
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- :ref:`Woman right turn from right over left hold`
- :ref:`Sombrero close`


.. _Woman right turn from right over left hold, man toss left turn:
...
.. _Woman right turn from right over left hold, man left turn, woman right turn via both arms:
...
.. _Woman right turn from right over left hold, catapult toss into open hold:

Woman right turn from right over left hold, catapult toss into open hold
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- Man signals a :ref:`Woman right turn from right over left hold` and immediately pulls his connected left hand to his left so that her left arm rests over her right bicep.
- Man tosses his connected left hand to his right and reconnects to end in open hold.


.. _Woman right turn from right over left hold, forearm throw down, guided hip spin:

Woman right turn from right over left hold, forearm throw down, guided hip spin
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Man signals a :ref:`Woman right turn from right over left hold` and immediately throws her forearms down, then guides her hips into a counterclockwise spin.
...
- He continues turning counterclockwise with :ref:`Right turn change hands`
...
- :ref:`Guapea`
- :ref:`Guapea`
- :ref:`Guapea` but as he continues swinging his left arm up he guides a `Woman right turn from closed hold`
...
- His left hand is connected to her right hand.
- Man pushes his connected left hand while she is walking forward to signal a :ref:`Woman right turn from closed hold` as he turns clockwise to face her, but he catches her while she is facing away from him and he pushes her back counterclockwise.
...
- On his left forward step, man signals :ref:`Right turn change hands`
- :ref:`Whip crossbody`
- :ref:`Man right turn`
...
- His right hand scoops under her left hand to enter right cross hold and he continues into :ref:`Man half right, woman blind turn`
...
- :ref:`Shoulder copa`
- :ref:`Crossbody`
- :ref:`Woman right turn from closed hold`, man hook spin
- :ref:`Right cross break`.
- :ref:`Toss inside turn via right hand`
- :ref:`Shoulder inside turn check`


Push crossbody, man matching spin, barrel scoop crossboy, barrel scoop crossbody, woman double right, woman right turn, left hook change hands, woman double right [#SalsaInternational]_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- :ref:`Crossbody`
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- :ref:`Woman right turn from right over left hold, man toss left turn`
...
- :ref:`Crossbody` into right hand over left hand hold.
- :ref:`Woman right turn from right over left hold, man left turn, woman right turn via both arms`
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- :ref:`Crossbody` into right hand over left hand hold.
- :ref:`Woman right turn from right over left hold` into left hand over right hand hold.
...
- :ref:`Crossbody`
- :ref:`Woman right turn from right over left hold, catapult toss into open hold`
- :ref:`Woman right turn from right over left hold, forearm throw down, guided hip spin`
- :ref:`Crossbody`
- :ref:`Woman double right`
- :ref:`Crossbody`
- :ref:`Man double left`
...
Guided shoulder hold, guided shoulder walk, inside turn [#MamboNova]_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
- From right cross hold, signal with a sideways open left palm for her left hand to enter left over right hold.
- On her forward step, spin her counterclockwise into :ref:`Guided shoulder walk`, then turn her counterclockwise into right over left hold.
- Hairbrush into :ref:`Guided shoulder walk`.
